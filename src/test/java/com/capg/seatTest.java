...
@Test
  public void testFindBySeatLocation() throws SeatNotFoundException {
      seatServiceImpl = new SeatServiceImpl();
  ...
  @Test
  public void testUpdateSeats() throws SeatNotFoundException {
	  seatServiceImpl = new SeatServiceImpl();
      // Arrange
      Seat seat = new Seat();
      seat.setSeatId(1);
  ...
  @Test
  public void testBookSeat() throws SeatNotFoundException {
	  seatServiceImpl = new SeatServiceImpl();
      // Arrange
      Seat seat = new Seat();
      seat.setSeatId(1);
